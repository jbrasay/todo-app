...
export default function App() {
  ...
  //Initialize the tasks by making a call to the server and retrieve data from the database
  useEffect(() => {
  ...
  return (
    <div className="flex flex-col h-screen items-center bg-stone-300">
      ...
      <div className="flex flex-col w-2/4 bg-pink-900 mt-24 rounded-2xl shadow-2xl">
        ...
        {/*Buttons to filter todos based on the status */}
      ...
      {/*Show the todos if it is not empty*/}
